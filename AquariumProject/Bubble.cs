 ...
 * Фак. No: F115436
 * Клас: Bubble
 * Описание: Клас, представляващ въздушно балонче (particle). 
...
namespace AquariumProject
{
    public class Bubble
    {
        ...
        public Bubble(int screenWidth, int screenHeight)
        {
            ...
            // ги разпръсква по целия екран първия път
        ...
        public void Move(int screenHeight, int screenWidth)
        {
            ...
            // ако балончето излезе отгоре, го връща долу
            if (Y + Size < 0)
            {
                Reset(screenWidth, screenHeight);
            }
